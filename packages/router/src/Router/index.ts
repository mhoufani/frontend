...
import { HandlerFunction } from 'RequestHandler/Handler';
...
/**
 * Request interface for the router based on the express request object
 * Todo: replace by the express request object
 * @interface Request
 * @property {string} url - The URL of the request
 * @property {string} protocol - The protocol of the request
 * @property {Object} headers - The headers of the request
 * @property {Object} [key: string]: any - The request object
 * @example
