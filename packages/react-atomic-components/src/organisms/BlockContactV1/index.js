...
export const BlockContactV1 = ({
  ...
  secondaryBtnText,
  primaryBtnText,
  primaryBtnTextMobile,
  ctaLink,
  classNames,
  isNested,
  imageData,
}) => {
  const primaryBtnTextMobileValue =
    primaryBtnTextMobile || primaryBtnText;
  ...
  return (
    ...
    >
      ...
      />
      <div className={cs(classNames.contentContainer)}>
        <TitleV2
          level={5}
        ...
        <div className={cs(classes.buttonsContainer)}>
          ...
          {phone && (
            ...
            >
              ...
              <span className={classes.primaryBtnTextMobile}>
                {primaryBtnTextMobileValue}
              </span>
            </NextBtnLink>
          )}
        </div>
...
BlockContactV1.propTypes = {
  ...
  primaryBtnTextMobile: PropTypes.node,
