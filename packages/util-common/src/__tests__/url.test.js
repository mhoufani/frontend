...
describe('url', () => {
  describe('Domain', () => {
    it('should return domain', () => {
      ...
      expect(Domain('https://www.google.com').getSld()).toEqual(
        'www'
      );
      expect(Domain('https://www.google.com').getTld()).toEqual(
        'com'
      );
      expect(
      ...
      expect(Domain('https://www.google.com').chain(x => x)).toEqual(
        'www.google.com'
      );
